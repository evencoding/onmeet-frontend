...
export default memo(function Sidebar({
  ...
  return (
    <div
      className={cn(
        "flex flex-col h-screen transition-all duration-300 dark:bg-gradient-to-b dark:from-purple-950/90 dark:via-black/80 dark:to-purple-950/90 dark:border-r dark:border-purple-500/20 dark:backdrop-blur-xl light:bg-white light:border-r-2 light:border-purple-200/80 light:shadow-[4px_0_24px_-4px_rgba(147,51,234,0.08)]",
            ...
            <div key={item.id} title={isCollapsed ? item.label : ""}>
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ? "dark:bg-purple-500/20 dark:text-purple-300 light:bg-purple-100 light:text-purple-900 light:shadow-sm light:shadow-purple-200/30 light:border light:border-purple-300/50"
                    : "dark:text-white/60 dark:hover:text-white/90 dark:hover:bg-purple-500/10 light:text-purple-600 light:hover:text-purple-900 light:hover:bg-purple-100/80 light:hover:shadow-sm light:hover:shadow-purple-200/20",
                )}
              >
      ...
      {!isCollapsed && (
        <div className="px-3 py-4 dark:border-t dark:border-purple-500/20 light:border-t light:border-purple-200/40">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectedTeamId === String(team.id)
                      ? "dark:bg-purple-500/20 dark:text-purple-300 light:bg-purple-100 light:text-purple-900 light:border light:border-purple-300/40"
                      : "dark:text-white/60 dark:hover:text-white/90 dark:hover:bg-purple-500/10 light:text-purple-600 light:hover:text-purple-900 light:hover:bg-purple-100/80 light:hover:shadow-sm",
                  )}
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 dark:text-white/50 dark:hover:text-white/80 dark:hover:bg-purple-500/10 light:text-purple-500 light:hover:text-purple-800 light:hover:bg-purple-100/80 light:hover:shadow-sm rounded-xl transition-all duration-200"
          >
