...
export default function MeetingPreparationModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="bg-gradient-to-br from-purple-900/95 via-purple-950/95 to-black/95 rounded-2xl border border-purple-500/30 w-full max-w-2xl mx-4 overflow-hidden">
        {/* Header */}
        ...
        <div className="px-8 py-6 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="relative w-full aspect-video bg-black rounded-xl overflow-hidden border border-purple-500/30">
              {isVideoOn ? (
                <video
                  ref={previewVideoRef}
                  autoPlay
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 bg-purple-500/20 border border-purple-500/30 rounded-lg text-white text-sm focus:outline-none focus:border-purple-400"
                >
                  {cameras.map((camera) => (
